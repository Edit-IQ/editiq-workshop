  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (error.code === 'auth/popup-closed-by-user') {
        ...
        alert("This domain is not authorized. Please add your Netlify domain to Firebase console.");
      } else {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-200 font-sans selection:bg-blue-500/30 pb-24 md:pb-0 overflow-x-hidden">
      ...
      <nav className="hidden md:flex fixed left-0 top-0 bottom-0 w-24 bg-slate-900/50 backdrop-blur-xl border-r border-slate-800/50 flex-col items-center py-10 z-50">
        <div className="w-12 h-12 bg-blue-600 rounded-2xl flex items-center justify-center text-white font-black text-xl mb-12 shadow-[0_0_20px_rgba(37,99,235,0.4)]">
          IQ
        </div>
          ...
          <div className="flex items-center justify-between mb-8 md:mb-12 glass-panel p-4 rounded-3xl">
            <div className="flex items-center gap-4 md:gap-6">
              <div className="flex items-center gap-3">
                ...
                <span className="hidden sm:block text-[11px] font-black uppercase tracking-widest text-slate-400">
                  {user.displayName}
                </span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[9px] font-black uppercase tracking-widest text-blue-500/80">
                  {firebase ? 'Firebase Connected' : 'Demo Mode'}
                </span>
              </div>
            </div>
